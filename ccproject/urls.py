...
from ccapp.views import home,ufoodlist,uhealthyrecipes,ulogin,usignup,ulogout,ufoodlog,uaddfooditem,ucustomized,uviewdetails,uhacks,ufoodlogdelete,weight_log,weight_log_delete
...
urlpatterns = [
    ...
    path('food/foodlog/delete/<int:food_id>',ufoodlogdelete,name='foodlogdelete'),
    path("weight_log/",weight_log,name="weight_log"),
    path('weight_log_delete/<int:weight_id>', weight_log_delete, name='weight_log_delete'),
